    ...
    */
    var sequelize = queryInterface.sequelize;
     ...
     return sequelize.transaction(function (t) {
          ...
          .then(function() {
              return queryInterface.removeColumn('TweetActions', "contacted_or_replied", Sequelize.BOOLEAN,  {transaction: t})
          })
          .then(function() {
             return queryInterface.removeColumn('TweetActions', "follower_or_friend", Sequelize.BOOLEAN,  {transaction: t})
          }) 
          .then(function() {
             return queryInterface.removeColumn('TweetActions', "read", Sequelize.BOOLEAN,  {transaction: t})
          }) 
      });
  }
};
