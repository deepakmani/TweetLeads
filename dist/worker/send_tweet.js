...
class SendTweet {
    constructor(queue, concurrency) {
        this.CONSUMER_KEY = "0CATYOWT4xuugZNXZ1rDVXwBM";
        this.CONSUMER_SECRET = "mzG2At2kbbOPwdXRP4dhqZjqolghouVPGWjR6iI3E82HOeTEcg";
        /*
        @name:	 start_queue
...
*/
    get_twitter_client(screen_name) {
        return new Promise((resolve, reject) => {
...
//# sourceMappingURL=send_tweet.js.map